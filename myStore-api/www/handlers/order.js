...
var decodeToken_1 = __importDefault(require("../middlewares/decodeToken"));
var order = new order_1.OrderController();
...
var create = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, order.Create(req.body, res.locals.data.result.id)];
            case 1:
                response = _a.sent();
                return [2 /*return*/, res.status(200).json(response)];
        }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, order.Show(userId)];
            case 1:
                response = _a.sent();
                return [2 /*return*/, res.status(200).json(response)];
        }
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                return [4 /*yield*/, order.Delete(userId)];
            case 1:
                response = _a.sent();
                return [2 /*return*/, res.status(200).json(response)];
        }
...
var addProduct = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
    var orderId, productId, quantity, products, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
            ...
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, order.addOrderProduct(quantity, orderId, productId)];
            case 2:
                products = _a.sent();
